...
contract register {
	...
	function addAccount(bytes32 _name,bytes32 _bs,bytes32 _email, bytes32 _mobile, bytes32 _password) public {
	...
	function viewAccounts() public view returns(bytes32[] memory, bytes32[] memory, bytes32[] memory, bytes32[] memory, bytes32[] memory) {
		return(name, bs, email,mobile,password);
	}
