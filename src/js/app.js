App = {
	...
	initWeb3: function() {
		...
		if(window.web3) {
			App.web3Provider = window.web3.currentProvider; // asking the metamask to connect with web app
		}
		else {
	...
	registerUser: function(event) {
		...
		web3.eth.getAccounts(function(error,accounts){
			...
			App.contracts.register.deployed().then(function(instance){
				...
				return registerInstance.addAccount(web3.fromAscii(name),web3.fromAscii(bs),web3.fromAscii(email),web3.fromAscii(mobile),web3.fromAscii(pwd),{from:account});
